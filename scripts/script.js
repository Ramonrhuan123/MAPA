...
function init() {
	...
	mymap = L.map('mapid').setView([-20.350566399999998, -40.2989056], 13);
    ...
    accessToken: 'pk.eyJ1Ijoiamdsb2JvIiwiYSI6ImNqd2x5NXp3NzAzdjAzenIydGkwaTllYmsifQ.amCKNDuZ0sR8FPgUhbFGAg'
	}).addTo(mymap);
	//Add Button Listener
